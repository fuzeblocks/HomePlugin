package fr.fuzeblocks.homeplugin.other.commands.home;

import fr.fuzeblocks.homeplugin.HomePlugin;
import fr.fuzeblocks.homeplugin.core.economy.EconomyManager;
import fr.fuzeblocks.homeplugin.core.event.OnHomeCreatedEvent;
import fr.fuzeblocks.homeplugin.core.home.HomeManager;
import fr.fuzeblocks.homeplugin.core.home.HomePermissionManager;
...
public class SetHomeCommand implements CommandExecutor {
    ...
    private static int getWorldMinY(World world) {
        ...
        } catch (ReflectiveOperationException | NoSuchMethodError e) {
            return 0;
        }
    }
