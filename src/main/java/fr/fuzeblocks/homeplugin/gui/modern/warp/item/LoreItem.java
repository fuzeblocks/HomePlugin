...
public class LoreItem extends AbstractItem {
    ...
    public ItemProvider getItemProvider(Player player) {
        return new ItemBuilder(Material.PAINTING).setName(HomePlugin.getLanguageManager().getStringWithColor("Warp.Modify.Lore-item-name", "&eRenommer la lore du warp"));
    }
